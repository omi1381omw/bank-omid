...
<div class="col-md-6">
        ...
        <form action="/bank_accounts" method="post">
            @csrf
            <div class="mb-3 mt-3">
                <label for="name" class="form-label">کاربر مالک:</label>
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="number" class="form-control" id="account_number" placeholder="شماره حساب..."
                    name="account_number" value="{{ old('account_number') }}">
            </div>
            <div class="mb-3 mt-3">
                <label for="sheba" class="form-label">شماره شبا:</label>
                <input type="number" class="form-control" id="sheba" placeholder="شماره شبا..." name="sheba"
                    value="{{ old('sheba') }}">
            </div>
            <div class="mb-3 mt-3">
                <label for="cart" class="form-label">شماره کارت:</label>
                <input type="number" class="form-control" id="cart" placeholder="شماره کارت..." name="cart"
                    value="{{ old('cart') }}">
            </div>
