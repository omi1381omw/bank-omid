...
<head>
    ...
    <link href="{{ asset('plugins/fonts.googleapis.css') }}" rel="stylesheet">
    <!-- Bootstrap 4 RTL -->
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <form class="form-inline ml-3">
    <div class="input-group input-group-sm">
      <input class="form-control form-control-navbar" type="search" placeholder="جستوجو.." aria-label="Search">
